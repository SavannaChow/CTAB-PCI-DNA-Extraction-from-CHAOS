...
- **建議步驟：空瓶 → 加入約 50% 目標體積的 ddH₂O → 慢慢加入 guanidine thiocyanate 粉末並攪拌溶解 → 加入 N-lauroyl sarcosine sodium 粉末並攪拌溶解 → 加入 1 M Tris pH 8 → 最後在 fume hood 加入 2-mercaptoethanol 原液 → 用 ddH₂O 補至最終體積 → 混合 30 分鐘至 1 小時。
 **
